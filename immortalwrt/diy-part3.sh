...
rm -rf package/emortal/autocore/files/*
pushd package/emortal/autocore/files
merge_package "-b openwrt-24.10 https://github.com/immortalwrt/immortalwrt" immortalwrt/package/emortal/autocore/files
popd
