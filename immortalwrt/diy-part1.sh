...
# cp -f $GITHUB_WORKSPACE/patches/filogic/999-2745-mtkhnat-add-mtkhnat-driver-support.patch target/linux/mediatek/patches-6.6/999-2745-mtkhnat-add-mtkhnat-driver-support.patch
