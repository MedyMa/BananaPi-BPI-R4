...
perl -0pi -e 's@mt7996_get_txpower\(struct ieee80211_hw \*hw, struct ieee80211_vif \*vif,\R\t\t   unsigned int link_id, int \*dbm\)@mt7996_get_txpower(struct ieee80211_hw *hw, struct ieee80211_vif *vif, int *dbm)@; s@(mt7996_get_txpower\(struct ieee80211_hw \*hw, struct ieee80211_vif \*vif, int \*dbm\)\R\{\R\tstruct mt7996_dev \*dev = mt7996_hw_dev\(hw\);)@$1\n\tunsigned int link_id = 0;@' "$D/mt7996/main.c"
