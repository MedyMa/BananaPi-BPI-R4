...
merge_package https://github.com/immortalwrt/luci luci/applications/luci-app-alist
merge_package https://github.com/immortalwrt/packages packages/net/alist
